...
export class Graphics extends mix(PIXI.Graphics).with(EmitterMixin, BaseMixin, DBMixin, PluginMixin, CommandMixin, ShortcutMixin, DisplayMixin, ContainerMixin, GraphicsMixin) {}
